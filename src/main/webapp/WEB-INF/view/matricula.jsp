...
<body>	
	...
	<ul>
		...
		<li><a href="matricula" class="ativa">Matricula</a>
            	...
            	<c:forEach var="d" items="${disciplinas}">
                	<c:choose>
                    	<c:when test="${d.dia_semana == 'Segunda-feira'}">
                            	...
                            	<td>
                            	 <form class="lista" action="matricula" method="post">
                                	...
                                	<input class="botao_lista" type="submit" name="botao" value="Matricular">
                            	</form>
                       		 </td>
                        	</tr>
                    	</c:when>
